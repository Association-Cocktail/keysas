...
// invalid_trailer_structure disabled: triggers on scanned PDFs and many legitimate documents
// rule invalid_trailer_structure : PDF raw { ... }

// multiple_versions disabled: author's own meta says "doesn't hold any weight"
// matches incremental-save PDFs (standard feature) — false positives on every edited document
