...
// private: helper rules used as conditions in other rules — must not match standalone
private rule IsPE32 : PECheck
{
	condition:
...
private rule IsNET_EXE : PECheck
{
	condition:
		pe.imports ("mscoree.dll","_CorExeMain")
}

private rule IsNET_DLL : PECheck
{
	condition:
		pe.imports ("mscoree.dll","_CorDllMain")
}

private rule IsDLL : PECheck
{
	condition:
		// MZ signature at offset 0 and ...
		uint16(0) == 0x5A4D and
...
private rule IsConsole : PECheck
{
	condition:
		// MZ signature at offset 0 and ...
		uint16(0) == 0x5A4D and
...
private rule IsWindowsGUI : PECheck
{
	condition:
		// MZ signature at offset 0 and ...
		uint16(0) == 0x5A4D and
...
private rule HasOverlay : PECheck
{
	meta: 
		author="_pusher_"
...
private rule HasTaggantSignature : PECheck
{
	meta: 
		author="_pusher_"
...
private rule HasDigitalSignature : PECheck
{
	meta: 
		author="_pusher_"
...
private rule HasDebugData : PECheck
{
	meta: 
		author = "_pusher_"
...
private rule IsBeyondImageSize : PECheck
{
	meta: 
		author = "_pusher_"
		date = "2016-07"
...
private rule ImportTableIsBad : PECheck
{
	meta: 
...
private rule ExportTableIsBad : PECheck
{
	meta: 
		author = "_pusher_ & mrexodia"
		date = "2016-07"
...
private rule HasModified_DOS_Message : PECheck
{
	meta: 
		author = "_pusher_"
...
private rule HasRichSignature : PECheck
{
	meta: 
		author = "_pusher_"
